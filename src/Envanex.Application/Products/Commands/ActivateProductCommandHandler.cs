...
public sealed class ActivateProductCommandHandler : ICommandHandler<ActivateProductCommand, Guid>
{
    ...
    public async Task<Result<Guid>> HandleAsync(ActivateProductCommand command, CancellationToken ct = default)
    {
