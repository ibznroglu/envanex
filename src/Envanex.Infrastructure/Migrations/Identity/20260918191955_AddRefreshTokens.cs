        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FamilyExpiresAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_CreatedAt_Id",
                schema: "auth",
                table: "RefreshTokens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_FamilyId_Live",
                schema: "auth",
                table: "RefreshTokens",
                column: "FamilyId",
                unique: true,
                filter: "[RotatedAt] IS NULL AND [RevokedAt] IS NULL");
