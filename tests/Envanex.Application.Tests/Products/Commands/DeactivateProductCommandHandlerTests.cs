...
public class DeactivateProductCommandHandlerTests
{
    ...
    private Product SeedActiveProduct()
    {
    ...
    [Fact]
    public async Task HandleAsync_WithExistingProduct_ShouldDeactivateAndReturnProductId()
    {
    ...
    {
        var command = new DeactivateProductCommand(Guid.CreateVersion7(), RowVersion);
